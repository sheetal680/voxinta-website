    ...
    >
      <body className="min-h-full flex flex-col bg-background text-text">
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#22C55E] shadow-lg shadow-green-500/25 transition-all duration-200 hover:bg-[#16A34A] hover:scale-110"
        >
          <svg
            width="28"
            height="28"
